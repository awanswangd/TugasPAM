...
import org.notes.project.ai.AIRepositoryImpl
import org.notes.project.ai.GeminiService
import org.notes.project.ai.createHttpClient
...
fun App(databaseDriverFactory: DatabaseDriverFactory) {
    ...
    val aiRepository = remember { AIRepositoryImpl(geminiService) }
    ...
    MaterialTheme(
        ...
        val viewModel: NotesViewModel = viewModel { NotesViewModel(repository, aiRepository) }
        val chatViewModel: ChatViewModel = viewModel { ChatViewModel(aiRepository) }
